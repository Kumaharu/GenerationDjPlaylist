...
def make_individual_playlist():
    sum_of_playlist_song = 12
    individual_playlist = {}
    i = 0
    while i < sum_of_playlist_song:
        individual_playlist.setdefault(i, random.randint(100, 105))
        i += 1
...
def main():
    ...
    plt.plot(keys2, values_ref, linewidth=4, color="orange")
    plt.legend()
