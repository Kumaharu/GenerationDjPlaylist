...
def make_individual_playlist():
    ...
    while i < sum_of_playlist_song:
        individual_playlist.setdefault(i, random.randint(100, 115))
        i += 1
...
def collection_of_individual_playlists():
    ...
    individual_playlist = {0: 105, 1: 103, 2: 105, 3: 105, 4: 104, 5: 104, 6: 104, 7: 104, 8: 105, 9: 101, 10: 105, 11: 103}
    i = 0
...
def evaluate(fitness_value_list):
    fitness_value_list.sort(reverse=True)
...
def two_point_crossover(parent1, parent2):
    ...
    parent1_song_number[0:5] =  parent2_gene
    #プレイリスト復元
...
def main():
    ...
    for individual_playlist in collection_of_individual_playlists():
        ...
        population.append((fitness(reference_playlist_vector,individual_playlist_vector),individual_playlist))
    ...
    for g in range(generation):
        ...
        while len(population) < sum_individual_length:
            ...
            if random.random() < mutate_rate:
                ...
                m2 = random.randint(0, len(elites) - 1)
                child = two_point_crossover(elites[m1][1], elites[m2][1])
            population.append((fitness(vector_instance.f(extract_bpm(REFERENCE_PLAYLIST)),vector_instance.f(extract_bpm(child))), child))
    ...
    for key in keys:
        if(key%5 == 0):
            key1.append(key)
    values = [population[0][1][key] for key in key1]
    print(keys)
    #参考プレリストのデータ
#
#     key2 = []
...
#         if(key%5 == 0):
#             key2.append(key)
#     values_ref = [REFERENCE_PLAYLIST[key] for key in key2]
#     plt.xlabel("song_number")
#     plt.ylabel("BPM")
#     plt.scatter(key2, values, label="Generated playlist")
#     plt.scatter(key2, values_ref, label="Reference playlist created by dj")
#     plt.plot(key2, values)
#     plt.plot(key2, values_ref, linewidth=4, color="orange")
#     plt.legend()
...
if __name__ == '__main__':
    ...
    REFERENCE_PLAYLIST = {0: 105, 1: 103, 2: 105, 3: 105, 4: 104, 5: 104, 6: 104, 7: 104, 8: 105, 9: 101, 10: 105, 11: 103}
